...
export default {
  ...
  // FooterTab
  //tabBarTextColor: (platform === 'ios') ? '#6b6b6b' : 'grey',
  tabBarTextColor: (platform === 'ios') ? '#6b6b6b' : '#f77b9a',
  tabBarTextSize: (platform === 'ios') ? 14 : 11,
  activeTab: (platform === 'ios') ? '#007aff' : '#fff',
  sTabBarActiveTextColor: '#007aff',
  //tabBarActiveTextColor: (platform === 'ios') ? '#007aff' : '#FF3366',
  tabBarActiveTextColor: (platform === 'ios') ? '#007aff' : '#fff',
  tabActiveBgColor: (platform === 'ios') ? '#cde1f9' : '#FF3366',
  //tabActiveBgColor: (platform === 'ios') ? '#cde1f9' : '#FCFCFB',
